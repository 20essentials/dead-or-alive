...
let nameSongs = [
	...
	"BRAND NEW LOVER", /*3*/
	"IN TOO DEEP", /*4*/
	"MY HEART GOES BANG", /*5*/
	" SOMETHING IN MY HOUSE", /*6*/
	"I'LL SAVE YOU ALL MY KISSES", /*7*/
	"TURN AROUND AND COUNT 2 TEN", /*8*/
	"COME HOME WITH ME BABY", /*9*/
	"HOOKED ON LOVE", /*10*/
	"MISTY CIRCLES", /*11*/
	"THAT'S THE WAY (I LIKE IT)", /*12*/
	"WHAT I WANT", /*13*/
